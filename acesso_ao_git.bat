...
git config --global user.name "arthurdoracio@gmail.com"
git config --global user.email "arthurproencadoracio"
echo 3 de 6: CONFIGURADO GLOBAL

:: Adiciona o repositório remoto (só executa se já não estiver adicionado)
git remote get-url origin >nul 2>&1
if errorlevel 1 (
    git remote add origin "https://github.com/arthurproencadoracio/AndroidPOO.git"
